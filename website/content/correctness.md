...
The 477 tests are split across six files by what they exercise:
...
| `test/convert.test.js` | 126 | Time specifications, option checking, column naming, channel selection, rate grouping, and the contents of the written CSV files |
