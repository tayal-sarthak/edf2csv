...
The 205 tests are split across five files by what they exercise:
...
| `test/docs.test.js` | 5 | That this documentation and the source agree on their lists of codes, flags and exit codes |
