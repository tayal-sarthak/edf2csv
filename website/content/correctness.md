...
The 204 tests are split across five files by what they exercise:
...
| `test/cli.test.js` | 90 | The built executable: exit codes, stdout versus stderr, overwrite refusal, unwritable destinations, invocation through a symlink as `npx` does |
