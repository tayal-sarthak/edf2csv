...
The 200 tests are split across five files by what they exercise:
...
| `test/cli.test.js` | 88 | The built executable: exit codes, stdout versus stderr, overwrite refusal, unwritable destinations, invocation through a symlink as `npx` does |
