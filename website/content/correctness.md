...
The 309 tests are split across six files by what they exercise:
...
| `test/cli.test.js` | 138 | The built executable: exit codes, stdout versus stderr, overwrite refusal, unwritable destinations, invocation through a symlink as `npx` does |
