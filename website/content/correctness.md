...
The 469 tests are split across six files by what they exercise:

| File | Tests | What it covers |
| --- | --- | --- |
| `test/edf.test.js` | 61 | Header parsing, diagnostics, digital-to-physical conversion, chunked reading, BDF, EDF+ annotation decoding |
...
| `test/docs.test.js` | 103 | That this documentation and the source agree on their lists of codes, flags and exit codes |
