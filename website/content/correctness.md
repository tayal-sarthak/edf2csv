...
The 426 tests are split across six files by what they exercise:
...
| `test/cli.test.js` | 162 | The built executable: exit codes, stdout versus stderr, overwrite refusal, unwritable destinations, invocation through a symlink as `npx` does |
| `test/docs.test.js` | 75 | That this documentation and the source agree on their lists of codes, flags and exit codes |
