...
The 442 tests are split across six files by what they exercise:
...
| `test/docs.test.js` | 84 | That this documentation and the source agree on their lists of codes, flags and exit codes |
