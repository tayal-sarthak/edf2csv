...
The 457 tests are split across six files by what they exercise:
...
| `test/convert.test.js` | 122 | Time specifications, option checking, column naming, channel selection, rate grouping, and the contents of the written CSV files |
...
| `test/docs.test.js` | 93 | That this documentation and the source agree on their lists of codes, flags and exit codes |
