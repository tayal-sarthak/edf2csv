...
| `start_seconds`, `end_seconds` | The window this run would convert, on that same clock. The whole recording when neither `--start` nor `--end` nor `--duration` was given |
